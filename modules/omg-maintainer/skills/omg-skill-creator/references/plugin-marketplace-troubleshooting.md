...
- `.agents-plugin/marketplace.json` exists at specified path?
...
| Error | Cause | Fix |
|-------|-------|-----|
| `File not found: .agents-plugin/marketplace.json` | Missing manifest | Create with required fields |
...
- See [Plugin caching docs](https://code.agents.com/docs/en/plugins-reference.md#plugin-caching-and-file-resolution)

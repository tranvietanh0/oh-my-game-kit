...
**Ultrathink** to exhaustively list ALL potential edge cases, then dispatch parallel `omg-code-reviewer` agents to verify: <scope>$ARGUMENTS</scope>
...
- Use `omg-scout` to find relevant files
...
- Ask: "Found N unhandled edge cases. Fix with omg-fix --parallel? [Y/n]"

### 7. Final Report
- Summary of verification
- Ask: "Commit? [Y/n]" → use `omg-git-manager`

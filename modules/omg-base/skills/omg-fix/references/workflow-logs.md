...
For fixing issues from application logs. Uses native Codex Tasks for phase tracking.
...
Use `omg-tester` agent. If issues remain → keep T5 `in_progress`, loop back to Step 2.

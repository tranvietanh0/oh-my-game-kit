...
- `Read` each `.agents/omg-routing-*.json` matching glob → routing fragments
- `Read` each `.agents/omg-activation-*.json` matching glob → activation fragments

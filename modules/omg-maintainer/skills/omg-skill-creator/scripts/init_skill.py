...
origin: [TODO: kit-name e.g. oh-my-game-kit-core — REQUIRED for new files; CI overwrites with canonical value post-merge]
repository: [TODO: org/repo e.g. The1Studio/oh-my-game-kit-core — optional; CI overwrites]
module: [TODO: module-name e.g. omg-base — optional; CI auto-resolves from path]
protected: [TODO: true|false — true for oh-my-game-kit-core, false elsewhere; CI overwrites]
---

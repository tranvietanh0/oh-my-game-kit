...
For fixing visual/UI issues. Requires design skills. Uses native Codex Tasks for phase tracking.
...
python3 $HOME/.agents/skills/ui-ux-pro-max/scripts/search.py "<style>" --domain style
...
Use `omg-tester` agent for compilation check.

...
Use `omg-code-reviewer` subagent for quick review.
...
**If autonomous mode:** Ask to commit via `omg-git-manager` subagent if score >= 9.0
...
| 4 | `omg-code-reviewer` subagent |
| 5 | `omg-git-manager` subagent |

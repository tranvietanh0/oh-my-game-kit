...
Full JSON schema for `.agents-plugin/marketplace.json`.
...
`codex-code-marketplace`, `codex-code-plugins`, `codex-plugins-official`, `anthropic-marketplace`, `anthropic-plugins`, `agent-skills`, `life-sciences`. Names impersonating official marketplaces also blocked.

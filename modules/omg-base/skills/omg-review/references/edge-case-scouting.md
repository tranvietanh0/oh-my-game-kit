...
description: Use after implementation, before code review to proactively find edge cases, side effects, and potential issues via scout skill - catches problems omg-code-reviewer might miss
...
### 2. Invoke Scout
```
omg-scout edge cases for recent changes.
...
6. Document for omg-code-reviewer
```

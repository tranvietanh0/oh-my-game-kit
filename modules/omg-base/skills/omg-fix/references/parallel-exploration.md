...
Task("omg-fullstack-developer", "Fix Issue A. Claim tasks via TaskUpdate.", "Fix A")
Task("omg-fullstack-developer", "Fix Issue B. Claim tasks via TaskUpdate.", "Fix B")
```
...
| 2+ independent issues | Task trees per issue + omg-fullstack-developer agents |

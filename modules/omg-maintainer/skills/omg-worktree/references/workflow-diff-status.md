...
node $HOME/.agents/skillsomg-worktree/scripts/worktree.cjs diff --json
# Specific worktree
...
```bash
node $HOME/.agents/skillsomg-worktree/scripts/worktree.cjs status --json
```
...
```bash
node $HOME/.agents/skillsomg-worktree/scripts/worktree.cjs list --json
```
